...
class Knight(color: Boolean) : Piece(color) {
    ...
    override fun getLegalEndPositionsFrom(position: Int): ArrayList<Int> {
        return when (position) {
            ...
            _g1 -> arrayListOf(_f3, _h3, _e2)
            _h1 -> arrayListOf(_g3, _f2)
            ...
            _g2 -> arrayListOf(_f4, _h4, _e3, _e1)
            _h2 -> arrayListOf(_g4, _f3, _f1)
            ...
            _g3 -> arrayListOf(_f5, _h5, _e4, _e2, _h1, _f1)
            _h3 -> arrayListOf(_g5, _f4, _f2, _g1)
            ...
            _g4 -> arrayListOf(_f6, _h6, _e5, _e3, _h2, _f2)
            _h4 -> arrayListOf(_g6, _f5, _f3, _g1)
            ...
            _g5 -> arrayListOf(_f7, _h7, _e6, _e4, _h3, _f3)
            _h5 -> arrayListOf(_g7, _f6, _f4, _g2)
            ...
            _g6 -> arrayListOf(_f8, _h8, _e7, _e5, _h4, _f4)
            _h6 -> arrayListOf(_g8, _f7, _f5, _g3)
            ...
            _g7 -> arrayListOf(_e8, _e6, _h5, _f5)
            _h7 -> arrayListOf(_f8, _f6, _g4)
            ...
            _g8 -> arrayListOf(_e7, _h6, _f6)
            _h8 -> arrayListOf(_f7, _g5)
