    ...
    override fun getLegalEndPositionsFrom(position: Int): ArrayList<Int> {
        return when(direction){
            ...
            DOWN -> when (position){
                ...
                _d7 -> arrayListOf(_d6,_d5,_c6,_e6)
                _e7 -> arrayListOf(_e6,_e5,_d6,_f6)
                _f7 -> arrayListOf(_f6,_f5,_e6,_g6)
                _g7 -> arrayListOf(_g6,_g5,_f6,_h6)
                _h7 -> arrayListOf(_h6,_h5,_g6,_i6)
                _i7 -> arrayListOf(_i6,_i5,_h6,_j6)
                _j7 -> arrayListOf(_j6,_j5,_i6)
                ...
                _a2 -> arrayListOf(_a1,_b1)
                _b2 -> arrayListOf(_b1,_a1,_c1)
                _c2 -> arrayListOf(_c1,_b1,_d1)
                _d2 -> arrayListOf(_d1,_c1,_e1)
                _e2 -> arrayListOf(_e1,_d1,_f1)
                _f2 -> arrayListOf(_f1,_e1,_g1)
                _g2 -> arrayListOf(_g1,_f1,_h1)
                _h2 -> arrayListOf(_h1,_g1,_i1)
                _i2 -> arrayListOf(_i1,_h1,_j1)
                _j2 -> arrayListOf(_j1,_i1)
