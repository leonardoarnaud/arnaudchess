...
class Archer(color: Boolean) : Piece(color) {
    ...
    override fun getLegalEndPositionsFrom(position: Int): ArrayList<Int> {
        return when (position) {
            ...
            _d3 -> arrayListOf(_d5, _f3, _d1, _b3, _f1, _b5, _b1)
            _d4 -> arrayListOf(_d6, _f4, _d2, _b4, _f2, _b6, _b2)
            _d5 -> arrayListOf(_d7, _f5, _d3, _b5, _f3, _b7, _b3)
            _d6 -> arrayListOf(_d8, _f6, _d4, _b6, _f4, _b8, _b4)
            ...
            _e3 -> arrayListOf(_e5, _g3, _e1, _c3 , _g1, _c5, _c1)
            _e4 -> arrayListOf(_e6, _g4, _e2, _c4 , _g2, _c6, _c2)
            _e5 -> arrayListOf(_e7, _g5, _e3, _c5 , _g3, _c7, _c3)
            _e6 -> arrayListOf(_e8, _g6, _e4, _c6 , _g4, _c8, _c4)
            ...
            _f3 -> arrayListOf(_f5, _h3, _f1, _d3, _h1, _d5, _d1)
            _f4 -> arrayListOf(_f6, _h4, _f2, _d4, _h2, _d6, _d2)
            _f5 -> arrayListOf(_f7, _h5, _f3, _d5, _h3, _d7, _d3)
            _f6 -> arrayListOf(_f8, _h6, _f4, _d6, _h4, _d8, _d4)
            ...
            _g3 -> arrayListOf(_g5, _i3, _g1, _e3, _i1, _e5, _e1)
            _g4 -> arrayListOf(_g6, _i4, _g2, _e4, _i2, _e6, _e2)
            _g5 -> arrayListOf(_g7, _i5, _g3, _e5, _i3, _e7, _e3)
            _g6 -> arrayListOf(_g8, _i6, _g4, _e6, _i4, _e8, _e4)
            ...
            _h3 -> arrayListOf(_h5, _j3, _h1, _f3, _j1, _f5, _f1)
            _h4 -> arrayListOf(_h6, _j4, _h2, _f4, _j2, _f6, _f2)
            _h5 -> arrayListOf(_h7, _j5, _h3, _f5, _j3, _f7, _f3)
            _h6 -> arrayListOf(_h8, _j6, _h4, _f6, _j4, _f8, _f4)
